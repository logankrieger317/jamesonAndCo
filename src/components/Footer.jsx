const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/profile.php?id=100086972482257',
      icon: (props) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/jameson.grooming/',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold leading-6 text-gray-900">Promotions</h3>
          ...
          <div className="mt-10 xl:mt-0">
            ...
            <form className="mt-6 sm:flex sm:max-w-md">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="w-full min-w-0 appearance-none rounded-md border-0 bg-white px-3 py-1.5 text-base text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:w-64 sm:text-sm sm:leading-6 xl:w-full"
